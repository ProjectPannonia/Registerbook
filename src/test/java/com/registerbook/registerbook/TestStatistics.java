...
public class TestStatistics {
    ...
    @Test
    public void test(){
        StatisticData test = statistics.getStatitstics(testArray);
        int resultNumberOfRegisteredMembers = test.getRegisteredMembers();
        int expectedNumberOfRegisteredMembers = 4;
        int resultNumberOfRegisteredBands = test.getNumberOfBands();
        int expectedNumberOfRegisteredBands = 3;
        System.out.println("Regisztrált zenészek - Expected: " + expectedNumberOfRegisteredMembers + ", Result: " + resultNumberOfRegisteredMembers);
        System.out.println("Registrált bandák - Expected: " + expectedNumberOfRegisteredBands + ", Result: " + resultNumberOfRegisteredBands);
